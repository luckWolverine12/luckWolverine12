var Creditly = (function() {
  ...
  var createSelectorValidatorMap = function(expirationSelector, creditCardNumberSelector, cvvSelector, options) {
    ...
    optionValues["security_code_message"] = optionValues["security_code_message"] || "codigo de seguranca esta invalido!";
    optionValues["number_message"] = optionValues["number_message"] || "cartao de credito esta invalido!";
    optionValues["expiration_message"] = optionValues["expiration_message"] || " Data de expiracao esta invalido!";
